...
function calculateResults(incomingData) {
    ...
    const pointsPerTransaction = incomingData.map(transaction=> {
      ...
      if(transaction.amount < 101 && transaction.amount > 50){
       over50 = transaction.amount - 50;//10
      }
...
function CustomerMonthlyPointsTable() {
    ...
    <div className="w3-container">    
        <div className="row">
            ...
            <h2>Customer's month-wise reward points accumulation</h2>
            </div>
        </div>      
        <div className="row">
            <div className="col-8">
  ...
  export default CustomerMonthlyPointsTable;